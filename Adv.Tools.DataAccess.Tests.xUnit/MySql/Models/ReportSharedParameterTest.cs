...
{
    public class ReportSharedParameterTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ReportSharedParameter));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ReportSharedParameter().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ReportSharedParameter>
            {
                new ReportSharedParameter()
                {
                    Id =0,
                    ModelName = "testModel",
                    ModelGuid = "testGuid",
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ReportSharedParameter>(TestDataBaseName);
            //Act
