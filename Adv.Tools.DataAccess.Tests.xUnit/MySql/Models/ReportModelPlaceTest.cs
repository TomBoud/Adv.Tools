...
{
    public class ReportModelPlaceTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ReportModelPlace));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ReportModelPlace().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ReportModelPlace>
            {
                new ReportModelPlace()
                {
                    Id =0,
                    ModelName = "testModel",
                    ModelGuid = "testGuid",
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ReportModelPlace>(TestDataBaseName);
            //Act
