...
{
    public class ReportLevelsMonitorTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ReportLevelsMonitor));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ReportLevelsMonitor().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ReportLevelsMonitor>
            {
                new ReportLevelsMonitor()
                {
                    Id =0,
                    ModelName = "testModel",
                    ModelGuid = "testGuid",
                    ...
                    IsCopyMonitor = true,
                    IsCopyMonitorHeb = "testבדיקה",
                    IsOriginValid = true,
                    IsOriginValidHeb = "בדיקה",
                    ObjectId = "testId",
                    ObjectName = "testName",
                    ObjectOrigin = "testOrigin",
                    ObjectType = "testType",
                }
            };
            //Act
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ReportLevelsMonitor>(TestDataBaseName);
            //Act
