...
{
    public class ExpectedGridsMonitorTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ExpectedGridsMonitor));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ExpectedGridsMonitor().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ExpectedGridsMonitor>
            {
                new ExpectedGridsMonitor()
                {
                    Id =0,
                    ModelName = "testModel",
                    ModelGuid = "testGuid",
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ExpectedGridsMonitor>(TestDataBaseName);
            //Act
