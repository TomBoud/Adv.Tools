...
{
    public class ReportCleanViewTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ReportCleanView));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ReportCleanView().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ReportCleanView>
            {
                new ReportCleanView()
                {
                    Id =0,
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ReportCleanView>(TestDataBaseName);
            //Act
