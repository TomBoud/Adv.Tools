...
{
    public class ReportProjectInfoTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ReportProjectInfo));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ReportProjectInfo().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ReportProjectInfo>
            {
                new ReportProjectInfo()
                {
                    Id =0,
                    ModelName = "testModel",
                    ModelGuid = "testGuid",
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ReportProjectInfo>(TestDataBaseName);
            //Act
