...
{
    public class ReportHeadRoomClearenceTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ReportHeadRoomClearence));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ReportHeadRoomClearence().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ReportHeadRoomClearence>
            {
                new ReportHeadRoomClearence()
                {
                    Id =0,
                    ModelName = "testModel",
                    ModelGuid = "testGuid",
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ReportHeadRoomClearence>(TestDataBaseName);
            //Act
