...
{
    public class ReportElementsWorksetTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ReportElementsWorkset));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ReportElementsWorkset().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ReportElementsWorkset>
            {
                new ReportElementsWorkset()
                {
                    Id =0,
                    ModelName = "testModel",
                    ModelGuid = "testGuid",
                    ...
                    ObjectWorkset = "testObjectWorkset",
                    ObjectId ="testObjectId",
                    ObjectCategory = "testObjectCategory",
                    ObjectFamily="testObjectFamily",
                }
            };
            //Act
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ReportElementsWorkset>(TestDataBaseName);
            //Act
