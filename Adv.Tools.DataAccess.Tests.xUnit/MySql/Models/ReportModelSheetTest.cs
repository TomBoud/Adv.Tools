...
{
    public class ReportModelSheetTest
    {
        ...
        {
            //Stage
            var task = _access.DeleteTableIfExists(TestDataBaseName, nameof(ReportModelSheet));
            //Act
            await task;
            //Assert
        ...
        {
            //Stage
            var query = new ReportModelSheet().GetCreateTableQuery(TestDataBaseName);
        ...
        {
            //Stage
            var models = new List<ReportModelSheet>
            {
                new ReportModelSheet()
                {
                    Id =0,
                    ModelName = "testModel",
                    ModelGuid = "testGuid",
                    ...
                    HasScale = true,
                    HasSharedParamValues = true,
                    HasTitleBlock = true,
                    IsDefaultApprovedBy = true,
                    IsDefaultCheckedBy = true,
                    IsDefaultDesignedBy = true,
                    IsDefaultDrawnBy = true,
                    IsDefaultName =     true,
                    IsDefaultNumber = true,
                    ProjBrowSheetName = "testName",
                    ProjBrowSheetNumber = "testNumber",
                    SheetTidpCodeValue = "testValue",
        ...
        {
            //Stage
            var task = _access.LoadDataSelectAllAsync<ReportModelSheet>(TestDataBaseName);
            //Act
