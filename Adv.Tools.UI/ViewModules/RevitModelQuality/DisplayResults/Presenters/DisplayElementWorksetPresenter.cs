...
{
    public class DisplayElementWorksetPresenter
    {
        //Fields
        private IDisplayElementWorksetView view;
        private IDisplayElementWorksetRepo repository;
        private BindingSource bindingSource;
        private IEnumerable<ReportElementsWorkset> bindingList;

        //Constructor
        public DisplayElementWorksetPresenter(IDisplayElementWorksetView view, IDisplayElementWorksetRepo repo)
        {
