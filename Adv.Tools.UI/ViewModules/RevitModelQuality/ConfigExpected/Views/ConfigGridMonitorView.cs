...
{
    public partial class ConfigGridMonitorView : Form, IConfigGridMonitorView
    {
        //Singleton
        private static ConfigGridMonitorView instance;

        //Constructor
        public ConfigGridMonitorView()
        {
            InitializeComponent();
        ...
        public static ConfigGridMonitorView GetInstance(Form parentMdiContainer)
        {
            if (instance is null || instance.IsDisposed)
            {
                instance = new ConfigGridMonitorView();
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            add_button.Click += delegate
            {
                ...
                details_tabPage.Text = "Add New Grids Monitor to a Revit Model";
