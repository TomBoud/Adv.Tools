...
{
    public class ConfigLevelMonitorPresenter
    {
        //Fields
        private IConfigLevelMonitorView view;
        private IConfigLevelMonitorRepo reposetory;
        private BindingSource bindingSource;
        private IEnumerable<ExpectedLevelMonitor> bindingList;

        //Constructor
        public ConfigLevelMonitorPresenter(IConfigLevelMonitorView view, IConfigLevelMonitorRepo repo)
        {
        ...
        {
            var selected = (ExpectedLevelMonitor)bindingSource.Current;
        ...
        {
            var model = new ExpectedLevelMonitor();
